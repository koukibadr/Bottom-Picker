...
class BottomPicker extends StatefulWidget {
  ...
  BottomPicker({
    ...
    this.onSubmit,
    this.onClose,
    this.bottomPickerTheme = defaultBottomPickerTheme,
    this.gradientColors,
    this.iconColor = defaultIconColor,
    this.selectedItemIndex = defaultSelectedIndex,
    this.buttonText,
    this.buttonTextStyle,
    this.displayButtonIcon = defaultDisplayButtonIcon,
    this.buttonSingleColor,
    this.backgroundColor = defaultBackgroundColor,
    this.pickerTextStyle = defaultPickerTextStyle,
    this.itemExtent = defaultItemExtent,
    this.displayCloseIcon = defaultDisplayCloseIcon,
  ...
  BottomPicker.date({
    ...
    this.buttonSingleColor,
    this.backgroundColor = defaultBackgroundColor,
    this.dateOrder = defaultDateOrder,
    this.pickerTextStyle = defaultPickerTextStyle,
    this.displayCloseIcon = defaultDisplayCloseIcon,
    this.closeIconColor = defaultCloseIconColor,
    this.layoutOrientation = defaultLayoutOrientation,
  ...
  BottomPicker.dateTime({
    ...
    this.minDateTime,
    this.maxDateTime,
    this.use24hFormat = defaultUse24hFormat,
    this.buttonText,
    this.buttonTextStyle,
    this.displayButtonIcon = defaultDisplayButtonIcon,
    this.buttonSingleColor,
